...
namespace Festifact.Api.Migrations
{
    ...
    [Migration("20230601161436_Added MaxTickets val")]
    partial class AddedMaxTicketsval
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Festifact.Api.Entities.Show", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDateTime = new DateTime(2023, 6, 1, 20, 14, 36, 672, DateTimeKind.Local).AddTicks(6464),
                            LocationId = 1,
                            Name = "Coolio",
                            PerformerId = 1,
                            StartDateTime = new DateTime(2023, 6, 1, 18, 14, 36, 672, DateTimeKind.Local).AddTicks(6414)
                        },
                        new
                        {
                            Id = 2,
                            Description = "Film",
                            EndDateTime = new DateTime(2023, 6, 1, 20, 14, 36, 672, DateTimeKind.Local).AddTicks(6482),
                            FilmId = 1,
                            LocationId = 1,
                            Name = "Film",
                            StartDateTime = new DateTime(2023, 6, 1, 18, 14, 36, 672, DateTimeKind.Local).AddTicks(6480)
                        });
                });
            ...
            modelBuilder.Entity("Festifact.Api.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfBirth = new DateTime(2003, 6, 1, 18, 14, 36, 672, DateTimeKind.Local).AddTicks(6516),
                            Email = "piet@test.nl",
                            Name = "Piet"
                        });
                });
